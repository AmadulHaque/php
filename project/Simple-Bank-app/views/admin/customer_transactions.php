                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <?php foreach ($transactions as $item): ?>
                          <tr>
                            ...
                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0"><?php echo $item['recipient_id'] ?></td>
                            <td class="whitespace-nowrap px-2 py-4 text-sm font-medium <?php echo $item['type'] == 1 ? 'text-emerald-600' : 'text-red-600'; ?>">
