                      ...
                      <div class="flex gap-x-4">
                        <span
                          ...
                          <span class="text-xl font-medium leading-none text-white">
                            <?php
                              $string = $item['name'] ;
                              $firstTwoLetters = substr($string, 0, 2);
                              $uppercaseFirstTwoLetters = strtoupper($firstTwoLetters); 
                              echo $uppercaseFirstTwoLetters; 
                            ?>
                          </span>
                        </span>
                        ...
                        <div class="flex-auto min-w-0">
                          <p
                            ...
                            <a href="/admin/transactions?id=<?php echo $item['id'] ?>">
                              <span
                          ...
                          <a href="/admin/transactions?id=<?php echo $item['id'] ?>"
                              class="relative truncate hover:underline"> <?php echo $item['email'] ?></a>
                          </p>
                        </div>
                      </div>
                    </li>
